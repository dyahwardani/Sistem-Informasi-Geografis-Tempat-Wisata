...
<div class="row">
    ...
    <div class="col-md-6">
        <p align="center">
            <a href="?m=tempat_list" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-chevron-left"></span> Lihat semua tempat</a>
            <!-- <a href="javascript:void(0)" onclick="showRoute()" class="btn btn-primary btn-sm" style="margin-left: 10px;"> <span class="glyphicon glyphicon-search"></span> Tampilkan Rute </a> -->
            <!-- <a href="?m=detail&ID=<?=$_GET['ID']?>" class="btn btn-primary btn-sm" style="margin-left: 10px;"><span class="glyphicon glyphicon-list"></span> Rute Detail</a> -->
        </p>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-image="assets/images/galeri/<?=$r->gambar?>" data-target="#image-gallery">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="col-md-2">
                    <button type="button" class="btn btn-success" id="show-previous-image">Previous</button>
                </div>
...
//koordinat lokasi berdasarkan id
var dst_pos = {
        lat : <?=$row->lat?>,
        lng : <?=$row->lng?>
    };
...
function tampilDetail(){          
    ...
    //mendapatkan posisi koordinat user 
