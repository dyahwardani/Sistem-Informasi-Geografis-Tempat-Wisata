...
require_once'functions.php';
    ...
    if($mod=='galeri_tambah'){
        ...
        if($id_tempat=='' || $gambar[name]=='')
            ...
            $db->query("INSERT INTO tb_galeri (id_tempat, gambar, nama_galeri) 
                    VALUES('$id_tempat', '$file_name', '$nama_galeri')");                       
        ...
        if($id_tempat=='')
            ...
            $db->query("UPDATE tb_galeri SET id_tempat='$id_tempat', nama_galeri='$nama_galeri' $sql_gambar WHERE id_galeri='$_GET[ID]'");
            redirect_js("index.php?m=galeri");
        }    
